...
// 1. Simpan Pelanggan (dengan alamat & telepon)
mysqli_query($conn, "INSERT INTO pelanggan (NamaPelanggan, Alamat, NomorTelepon) 
                     VALUES ('$nama', '$alamat', '$telp')");
$id_pelanggan = mysqli_insert_id($conn);

// 2. Simpan Penjualan
mysqli_query($conn, "INSERT INTO penjualan (TanggalPenjualan, TotalHarga, PelangganID) 
