...
<head>
    ...
    <title>Invoice #<?= $id; ?> - Kasir Pro Elite</title>
            ...
            <div class="invoice-card animate__animated animate__fadeIn">
                <div class="invoice-header d-flex justify-content-between align-items-start">
                    ...
                    <div class="text-end">
                        ...
                        <p class="mb-0 opacity-75 small">Sistem Kasir Elitt</p>
                    </div>
                </div>
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="text-center mt-5">
                        <p class="text-muted small">Terima kasih telah berbelanja di Kasir Pro Elite.<br>Simpan nota ini sebagai bukti transaksi yang sah.</p>
